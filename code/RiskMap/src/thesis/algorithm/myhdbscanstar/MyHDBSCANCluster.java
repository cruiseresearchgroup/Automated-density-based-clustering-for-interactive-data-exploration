...
public class MyHDBSCANCluster {
	...
	private MyHDBSCANCluster parent;
	private boolean hasChildren;
	public ArrayList<MyHDBSCANCluster> propagatedDescendants;
	 ...
	 */
	public MyHDBSCANCluster(int label, MyHDBSCANCluster parent, double birthLevel, int numPoints) {
		this.label = label;
		...
		this.propagatedDescendants = new ArrayList<MyHDBSCANCluster>(1);
	}
	...
	public MyHDBSCANCluster getParent() {
		return this.parent;
	}
	...
	public ArrayList<MyHDBSCANCluster> getPropagatedDescendants() {
